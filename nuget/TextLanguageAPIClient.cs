...
namespace APIVerve.API.TextLanguage
{
    ...
    /// <summary>
    /// Client for the TextLanguage API
    /// </summary>
    public class TextLanguageAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/textlanguage";
        ...
        public TextLanguageAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TextLanguageAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TextLanguageAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, TextLanguageQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(TextLanguageQueryOptions options)
        {
        ...
        public ResponseObj Execute(TextLanguageQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TextLanguageQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TextLanguageQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TextLanguageQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TextLanguageQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TextLanguageQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(TextLanguageQueryOptions options)
        {
