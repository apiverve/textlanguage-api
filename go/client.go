// Package textlanguage provides a Go client for the Text Language API.
//
// For more information, visit: https://apiverve.com/marketplace/textlanguage?utm_source=go&utm_medium=readme
...
const (
	baseURL        = "https://api.apiverve.com/v1/textlanguage"
	defaultTimeout = 30 * time.Second
)

// Client is the Text Language API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Text Language API client.
...
// Execute makes a request to the Text Language API with typed parameters.
//
