...
```gradle
dependencies {
    implementation 'com.github.apiverve:textlanguage-api:1.1.12'
}
```
...
```java
import com.apiverve.textlanguage.TextLanguageAPIClient;
import com.apiverve.textlanguage.APIResponse;
import com.apiverve.textlanguage.APIException;

// Initialize the client
TextLanguageAPIClient client = new TextLanguageAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/textlanguage](https://docs.apiverve.com/ref/textlanguage)
...
- **Documentation:** [https://docs.apiverve.com/ref/textlanguage](https://docs.apiverve.com/ref/textlanguage)
- **Issues:** [GitHub Issues](https://github.com/apiverve/textlanguage-api/issues)
